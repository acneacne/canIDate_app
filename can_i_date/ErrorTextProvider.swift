...
struct ErrorTextProvider {
    let messages = ["Please enter some ages values", "Come on, type the ages", "Step 1: Ages. Step 2: Heart", "Ages, ages, ages", "Enter ages and touch the heart","Instructions: Enter ages", "Not so fast. First enter the ages","Ouch!"]
